...
#connection
$ns duplex-link $client1 Sserver1 12Mb 100ms DropTail
$ns duplex-Link $client2 $server1 12Mb 100ms DropTatl 
$ns duplex-Link Sattacker $server1 12Mb 100ms DropTail
$ns duplex-Link $server1 Sserver2 6Mb 200ms DropTail
